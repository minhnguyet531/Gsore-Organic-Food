    ...
    **************************** */
    $('[data-countdown]').each(function () {
        ...
        $this.countdown(finalDate, function (event) {
            $this.html(event.strftime('<div class="cdown day">%-D <p>Ngày</p></div> <div class="cdown hour">%-H <p>Giờ</p></div> <div class="cdown minutes">%M <p>Phút</p></div> <div class="cdown second">%S <p>Giây</p></div>'));
        });
    });
